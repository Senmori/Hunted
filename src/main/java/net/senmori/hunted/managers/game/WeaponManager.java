...
import net.senmori.hunted.kit.enums.Bow.BowName;
import net.senmori.hunted.kit.enums.Bow.BowTitle;
import net.senmori.hunted.kit.enums.Sword.SwordName;
import net.senmori.hunted.kit.enums.Sword.SwordTitle;
...
public class WeaponManager
{
	...
	public ItemStack generateWeapon() {
		...
		boolean isAscented = rand.nextInt(101) % ConfigManager.ascentedItemChance == 0 ? true : false;
		...
		// if it is ascented, redo displayname because it's easier
		...
		int maxLevel = isAscented ? ConfigManager.maxEnchantLevel*2 : ConfigManager.maxEnchantLevel;
		int minLevel = isAscented ? ConfigManager.maxEnchantLevel : 1;
