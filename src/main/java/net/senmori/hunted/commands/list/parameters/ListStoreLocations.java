...
public class ListStoreLocations extends Subcommand {
    ...
    private static final String NUM_LOC = "There are {0} store locations for this map.";
    ...
    protected void perform() {
        List<SerializedLocation> locations = Hunted.getInstance().getSpawnManager().getLocationsByType(LocationType.STORE);
