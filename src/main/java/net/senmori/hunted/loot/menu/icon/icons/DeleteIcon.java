...
import net.senmori.hunted.loot.menu.LootPoolMenu;
...
public class DeleteIcon implements Icon {
    ...
    private LootPoolMenu parent;
    private LootPool pool;
    private int slot;
    private ItemStack stack;

    public DeleteIcon(int slot, LootPool pool, LootPoolMenu parent) {
        this.parent = parent;
        this.slot = slot;
        this.pool = pool;
    ...
    public LootPoolMenu getParent() { return this.parent; }
